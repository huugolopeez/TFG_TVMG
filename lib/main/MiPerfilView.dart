  ...
  void onHLButtonsBoarding(int index) async {
    if(index == 0) {
      ...
      if(isPhoto) {
        ...
        String rutaEnNube = 'imgPerfil/${FirebaseAuth.instance.currentUser!.uid}/${DateTime.now().millisecondsSinceEpoch}.jpg';
      ...
      String userName = tecUser.text.trim().isNotEmpty ? tecUser.text : DataHolder().selectedUser.username;
      int seguidores = DataHolder().selectedUser.seguidores;
      int seguidos = DataHolder().selectedUser.seguidos;
      String url = imgUrl.trim().isNotEmpty ? imgUrl : DataHolder().selectedUser.urlPerfil;

      DataHolder().firebaseAdmin.updateUser(FbUsuario(username: userName, seguidores: seguidores, seguidos: seguidos, urlPerfil: url));
                ...
                child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                          ...
                          child: Icon(
                              Icons.image, color: DataHolder().colorPrincipal)
                      ),
                    ]),
              ),
              Row(
                ...
                children: [
                  Padding(
                      ...
                      child: ConstrainedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {onHLButtonsBoarding(0); },
                            style: ButtonStyle(
                  ...
                  Padding(
                    ...
                    child: ConstrainedBox(
                      ...
                      const BoxConstraints.tightFor(width: 150, height: 50),
                      child: ElevatedButton(
                        onPressed: () {onHLButtonsBoarding(1); },
                        style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all(
